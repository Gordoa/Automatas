...
class lexer implements lexerConstants {
   ...
   static int pos=0;
   static String modTemp, tipoDatoTemp, nombreTemp, valTemp;
   ...
   static Token tipoDato;
        public static void main(String[] args) throws ParseException, FileNotFoundException
        {
                ...
                System.out.println("Linea: "+tablaSimbolos.get(posclase).getPosicion()+" Nombre: "+tablaSimbolos.get(posclase).getName()+
              ...
              //Impresion de los demas Tokens
                          for ( int i = 0; i < tablaSimbolos.size()-1; i ++){
                                System.out.println("Posicion: "+tablaSimbolos.get(i).getPosicion()+" Nombre: "+tablaSimbolos.get(i).getName()+
  ...
  static final public void programa() throws ParseException {
    ...
    try {
      ...
      temp.setTipoDato("No Aplica");
          temp.setName(nombre.image);
          temp.setModificador(modificador.image);
          temp.setValor("No aplica");
          temp.setPosicion(modificador.beginLine);
...
/*M�todos para field_declaration*/
  ...
  static final public void variable_declaration() throws ParseException {
    ...
    jj_consume_token(PUNTOYCOMA);
          ...
          modTemp=modificador.image;
          tempgeneral.setPosicion(modificador.beginLine);
          tempgeneral.setTipo("Variable");
          tempgeneral.setUso("Declaracion");
          tempgeneral.setModificador(modTemp);
          tempgeneral.setTipoDato(tipoDatoTemp);
          tempgeneral.setName(nombreTemp);
          tempgeneral.setValor(valTemp);
           Validacion val=new Validacion();
           val.checarSiExisteToken(tempgeneral);
           val.validaTipos(tempgeneral);
  ...
  Token valor;
    ...
    jj_consume_token(PUNTOYCOMA);
        ...
        Validacion val=new Validacion();
        val.asignaVarDentro(identificadorvar,valorvar, identificador.beginLine);
  }
   ...
   Token valor2=null;
    ...
    default:
     ...
     val.obtenerDatoComparacion(valtemp,valtemp2, nombrecomparacion1.beginLine);
         ...
         tempgeneral.setPosicion(nombrecomparacion2.beginLine);
     ...
     tempgeneral.setName(nombrecomparacion1.image);
     tempgeneral.setTipo("Variable");
     tempgeneral.setTipoDato("Comparacion: "+expresion.image+"  ");
         }else {
     tempgeneral.setName("No hay variables");
     tempgeneral.setTipoDato("Comparacion: "  +expresion.image+"  ");
         }
